...
typedef struct
{
    ...
    __IO uint32_t PAD_CFG[40];                  /*!< Offset:  0X74 */
...
//#define I2C1_BASE              (APB_BASE + 0x5000UL)
...
#define SPIM0_BASE             (0x10000000UL)

#define RF_BASE                (0xA0010000UL)

#define USB_BASE               (0x80000000UL)
#define BB_BASE                (0x80001000UL)
#define DMA_BASE               (0x80020000UL)
