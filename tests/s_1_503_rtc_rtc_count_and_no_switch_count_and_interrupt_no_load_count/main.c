...
int main (void)
{
    ...
    LOGUartInit();
    c_printf("s_1_503_rtc_rtc_count_and_no_switch_count_and_interrupt_no_load_count case \r\n");
    {
    ...
    c_printf("s_1_503_rtc_rtc_count_and_no_switch_count_and_interrupt_no_load_count case completed \r\n");
	MCU_Sleep(3);
    SimulationEnd();
    while(1){     
    };
