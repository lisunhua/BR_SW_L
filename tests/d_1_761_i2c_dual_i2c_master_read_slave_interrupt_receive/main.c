...
int main (void)
{
    ...
    c_printf("d_1_761_i2c_dual_i2c_master_read_slave_interrupt_receive case \r\n");
    MCU_Sleep(1);
    ...
    MCU_Sleep(15);
    c_printf("d_1_761_i2c_dual_i2c_master_read_slave_interrupt_receive case completed \r\n");
    SimulationEnd();
    while(1){     
    };
}
