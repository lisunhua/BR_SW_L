...
int main (void)
{
    ...
    LOGUartInit();
    c_printf("s_1_629_scu_h_p_clk_96_no_to_pclk case \r\n");
    c_printf("Simu HCLK96M,PCLK 96M,PClkSelect 2 PCLK \r\n"); 
    {
	...
	MCU_Sleep(3);
    c_printf("s_1_629_scu_h_p_clk_96_no_to_pclk case completed \r\n");
    SimulationEnd();
    while(1){     
    };
}
