...
int main (void)
{
    ...
    LOGUartInit();
    c_printf("s_1_623_scu_change_pclk_no_delay_resert_uart0_tx case \r\n");

    {
        c_printf("SCU pclk 24M [%ld]\n",SystemCoreClock); 
        SystemCoreClock = 6000000;	
        c_printf("SCU pclk 6M [%ld]\n",SystemCoreClock);
    ...
    MCU_Sleep(3);
    c_printf("s_1_623_scu_change_pclk_no_delay_resert_uart0_tx case completed \r\n");
    SimulationEnd();
    while(1){     
    };
}
