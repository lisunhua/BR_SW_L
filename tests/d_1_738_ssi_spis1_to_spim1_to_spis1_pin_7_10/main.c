...
int main (void)
{
    ...
    c_printf("d_1_738_ssi_spis1_to_spim1_to_spis1_pin_7_10 case \r\n");
    Verrify_SendPinConnect(DUAL_SPI1_07TO10_PIN_EN);
    {
	...
	MCU_Sleep(10);
    c_printf("d_1_738_ssi_spis1_to_spim1_to_spis1_pin_7_10 case completed \r\n");
    SimulationEnd();
    while(1){     
    };
}
