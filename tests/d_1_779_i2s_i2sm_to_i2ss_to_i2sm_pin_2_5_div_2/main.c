...
int main (void)
{
    ...
    SCU_I2SDiv(2);
    c_printf("d_1_779_i2s_i2sm_to_i2ss_to_i2sm_pin_2_5_no_4_div_2 case \r\n");
    MCU_Sleep(1);
    Verrify_SendPinConnect(DUAL_I2S_2TO5_PIN_EN);
    {
	...
	MCU_Sleep(20);
    c_printf("d_1_779_i2s_i2sm_to_i2ss_to_i2sm_pin_2_5_no_4_div_2 case completed \r\n");
    SimulationEnd();
    while(1){     
    };
}
