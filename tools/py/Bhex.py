...
if fileName.split("/")[-1][0] == "s" or fileName =="d_1_210_bb_bt_br_lm":
	FlieSave(fileName+"_rom0.hex",bin1,"w")
	FlieSave(fileName+"_rom1.hex",bin2,"w")
	FlieSave(fileName+"_rom2.hex",bin3,"w")
else :
	FlieSave(fileName+"_clt_rom0.hex",bin1,"w")
	FlieSave(fileName+"_clt_rom1.hex",bin2,"w")
	FlieSave(fileName+"_clt_rom2.hex",bin3,"w")

	FlieSave(fileName+"_svr_rom0.hex",bin1,"w")
	FlieSave(fileName+"_svr_rom1.hex",bin2,"w")
	FlieSave(fileName+"_svr_rom2.hex",bin3,"w")
